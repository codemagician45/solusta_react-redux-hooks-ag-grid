...
function NewCategory(props) {
  ...
  const categories = useSelector(
    ({ registration }) => registration.attendee.categories
  );
  const loading = useSelector(
    ({ registration }) => registration.attendee.loading
  );
